...
//
//    private val channelIdForTokensPairs = hashMapOf<String, TokensPair>()
...
//            channelIdForTokensPairs.put(pairTicker.value["id"].asText(), TokensPair.fromLabel(pairTicker.key, "_"))
//        }
//    }
//
...
//
//        pairsTickers.fields().forEach { pairTicker ->
//            val pair = channelIdForTokensPairs.putIfAbsent(pairTicker.value["id"].asText(), TokensPair.fromLabel(pairTicker.key, "_"))
